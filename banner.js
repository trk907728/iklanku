...
(async () => {
    ...
    let htmlOpen = `<a href="https://bit.ly/3Be8tsp" target="_blank" rel="nofollow" onclick="closeSwallFromAdClick()"><img src="https://ads.soalcinta.my.id/10.10_Parade_Diskon.png" style="max-width:100%" /></a>`;
